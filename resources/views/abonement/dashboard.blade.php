                            ...
                            <div class="bg-green-600 border rounded shadow p-2">
                                <div class="flex flex-row items-center">
                                    ...
                                    <div class="flex-1 text-right">
                                        <h5 class="text-white">Barcha kitobxonlar</h5>
                                        <h3 class="text-white text-3xl">{{ $readers }}<span class="text-green-400"><i
                        ...
                        <div class="w-full md:w-1/2 xl:w-1/3 pt-3 px-3 md:pl-2">
                            <div class="bg-blue-600 border rounded shadow p-2">
                                <div class="flex flex-row items-center">
                                    ...
                                    <div class="flex-1 text-right">
                                        <h5 class="text-white">Barcha kitoblar</h5>
                                        <h3 class="text-white text-3xl">{{ $books }}<span class="text-blue-400"><i
                            ...
                            <div class="bg-orange-600 border rounded shadow p-2">
                                <div class="flex flex-row items-center">
                                    ...
                                    <div class="flex-1 text-right pr-1">
                                        <h5 class="text-white">Bugun topshirilgan kitoblar</h5>
                                        <h3 class="text-white text-3xl">{{ $today_issues }}<span class="text-orange-400"><i
                                                    class="fas fa-caret-up"></i></span></h3>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="w-full md:w-1/2 xl:w-1/3 pt-3 px-3 md:pr-2 xl:pl-2 xl:pr-3">
                            <div class="bg-red-600 border rounded shadow p-2">
                                <div class="flex flex-row items-center">
                                    ...
                                    <div class="flex-1 text-right">
                                        <h5 class="text-white">Qaytarilmagan kitoblar</h5>
                                        <h3 class="text-white text-3xl">{{ $issues }}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
...
{{--                                        <h3 class="text-white text-3xl">3 <span class="text-pink-400"><i--}}
{{--                                                    class="fas fa-caret-up"></i></span></h3>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
